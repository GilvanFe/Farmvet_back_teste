...
return [
    ...
    'Error' => [
        ...
        ROOT . '/src/Controller/FornecedorController.php', // Ignora depreciações no FornecedorController
    ],
    ],
    ...
    'Datasources' => [
         ...
         */
        // Dentro do array 'Datasources' no seu config/app.php
        'test' => [
            'className' => 'Cake\Database\Connection',
            'driver' => env('DB_TEST_DRIVER', 'Cake\Database\Driver\Postgres'), // Padrão para Postgres
            'persistent' => false,
            'host' => env('DB_TEST_HOST', 'localhost'), // Será 'postgres' no CI via variável de ambiente
            'port' => env('DB_TEST_PORT', '5432'),     // Porta padrão do PostgreSQL
            'username' => env('DB_TEST_USERNAME'),     // DEVE ser definido pela variável de ambiente
            'password' => env('DB_TEST_PASSWORD'),     // DEVE ser definido pela variável de ambiente
            'database' => env('DB_TEST_DATABASE'),     // DEVE ser definido pela variável de ambiente
            'encoding' => 'utf8', // Consistente com seu app_local.php
            'timezone' => 'UTC',
            'cacheMetadata' => true,
            'quoteIdentifiers' => false,
            'log' => false,
            // 'schema' => 'public', // Descomente se você usar um schema específico
            // 'url' => env('DATABASE_TEST_URL', null), // Alternativa se você preferir usar uma DSN string
        ],
    ],
