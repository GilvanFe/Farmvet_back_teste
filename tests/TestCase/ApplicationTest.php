...
class ApplicationTest extends TestCase
{
    ...
    public function testSwaggerJsonReturnsValidStructure(): void
    {
        $this->get('/docs');
        ...
        $this->assertResponseContains('Swagger UI');
        $this->assertResponseContains('swagger-ui-bundle.js');
        $this->assertResponseContains('/swagger.json');
